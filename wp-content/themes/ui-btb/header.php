      ...
      <div class="navbaritems">
        <ul class="items">
          ...
          <li class="menu-item hasdropdown">
            <a href="<?php bloginfo('url') ?>/treatments-category/primary-care/" class="menu-link">
              <span class="menutext">
                PRIMARY CARE
              </span>
            </a>
          ...
          <li class="menu-item hasdropdown">
            <a href="<?php bloginfo('url') ?>/treatments-category/aesthetics/" class="menu-link">
              <span class="menutext">
                AESTHETICS
              </span>
            </a>
          ...
          <li class="menu-item hasdropdown">
            <a href="<?php bloginfo('url')?>/conditions/" class="menu-link">
              <span class="menutext">
                CONDITIONS
              </span>
            </a>
